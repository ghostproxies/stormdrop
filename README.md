...
As proven by [ZoneSplit](https://github.com/ghostproxies/zonesplit), StormDrop guarantees up to 2⁶⁴ parallel instances that each output at least 2⁶⁴ results without full state overlap among the set of parallel instances.
